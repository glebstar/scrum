...
$( ".add-card-form form" ).submit(function( event ) {
    ...
    $.post('/addcard', data, function(data){
        ...
        $('#'+insertTarget).append('<div id="card-number-' + data.new_id + '" data-column="Todo" class="list-item clearfix"><div class="item-body"><p class="item-title">'+textVal+'</p><div class="clearfix"><div class="title-panel"><span title="Comments" class="glyphicon glyphicon-comment" aria-hidden="true"></span><span class="number" id="card-count-comments-' + data.new_id + '">0</span><span title="Description" class="glyphicon glyphicon-tasks" aria-hidden="true"></span><span class="number">0</span><span title="Attachments" class="glyphicon glyphicon-paperclip" aria-hidden="true"></span><span class="number">0</span></div><div class= "item-number pull-right">#<span>'+ data.new_id +'</span></div></div><div class="clearfix"><div class="members-list pull-right clearfix"></div></div></div><p class="start-card" data-target="doing-lists">Start</p></div><div id="card-members-' + data.new_id + '" class="hidden"></div><div id="card-comments-' + data.new_id +'" class="hidden"></div>');
